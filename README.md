...
| `make debug` | Prints all limit events from the last 7 days plus the watcher's resulting target schedule. |
...
| `make debug`    | Print recent 7-day limit events, confirmed candidates, and desired pending jobs in readable text. |
